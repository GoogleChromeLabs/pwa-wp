...
class WP_Service_Workers extends WP_Scripts {
	...
	protected function get_precaching_for_routes_script( $routes ) {
		...
		// @todo The ignoreUrlParametersMatching arg here may not be correct.
		return sprintf( "wp.serviceWorker.precaching.precacheAndRoute( %s, { ignoreUrlParametersMatching: [/.*/] } );\n", wp_json_encode( $routes_list ) );
	}
