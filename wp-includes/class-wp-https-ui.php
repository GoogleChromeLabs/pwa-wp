...
class WP_HTTPS_UI {
	...
	public function render_https_settings() {
		...
		$description       = sprintf(
			...
			__( 'There are %1$d non-HTTPS URLs on your home page. They will be upgraded to HTTPS automatically, but you might check to be sure your page looks as expected. %1$s', 'pwa' ),
			$total_urls_count,
			sprintf(
				'<a href="%s">%s</a>',
